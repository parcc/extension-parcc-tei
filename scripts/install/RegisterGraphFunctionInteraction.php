...
class RegisterGraphFunctionInteraction extends RegisterPortableElement
{
    protected function getSourceDirectory(){
        ...
        return $viewDir.implode(DIRECTORY_SEPARATOR, ['js', 'pciCreator', 'ims', 'graphFunctionInteraction']);
    }
}
