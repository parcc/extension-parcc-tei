define([
    ...
    var localRequire = PortableElement.getLocalRequire('graphFunctionInteraction', 'parccTei/pciCreator/dev/graphFunctionInteraction/', {}, {
        runtimeLocation : 'parccTei/pciCreator/dev/graphFunctionInteraction/',
