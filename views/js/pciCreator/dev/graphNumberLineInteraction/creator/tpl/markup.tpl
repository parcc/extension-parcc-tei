        ...
        <div class="shape-controls clearfix">
            <div class="intervals-available">
                <div class="intervals-row">
                    <button name="closed-closed" value="closed-closed" class="btn btn-info" type="button">
                        <img src="graphNumberLineInteraction/runtime/img/close-close.svg"/>
                    </button>
                    <button name="closed-open" value="closed-open" class="btn btn-info" type="button">
                        <img src="graphNumberLineInteraction/runtime/img/close-open.svg"/>
                    </button>
                    <button name="open-closed" value="open-closed" class="btn btn-info" type="button">
                        <img src="graphNumberLineInteraction/runtime/img/open-close.svg"/>
                    </button>
                    <button name="open-open" value="open-open" class="btn btn-info" type="button">
                        <img src="graphNumberLineInteraction/runtime/img/open-open.svg"/>
                    </button>
                </div>
                <div class="intervals-row">
                    <button name="arrow-open" value="arrow-open" class="btn btn-info" type="button">
                        <img src="graphNumberLineInteraction/runtime/img/arrow-open.svg"/>
                    </button>
                    <button name="arrow-closed" value="arrow-closed" class="btn btn-info" type="button">
                        <img src="graphNumberLineInteraction/runtime/img/arrow-close.svg"/>
                    </button>
                    <button name="open-arrow" value="open-arrow" class="btn btn-info" type="button">
                        <img src="graphNumberLineInteraction/runtime/img/open-arrow.svg"/>
                    </button>
                    <button name="closed-arrow" value="closed-arrow" class="btn btn-info" type="button">
