...
}var _debug=!1,_defaults={color:"#326399"},_style={opacityDefault:_debug?.1:0,opacityHover:.3,opacitySelected:.6};return{initialize:initialize}}),define("graphLineAndPointInteraction/runtime/graphLineAndPointInteraction",["taoQtiItem/portableLib/jquery_2_1_1","qtiCustomInteractionContext","taoQtiItem/portableLib/OAT/util/event","taoQtiItem/portableLib/lodash","taoQtiItem/portableLib/OAT/scale.raphael","taoQtiItem/portableLib/raphael","parccTei/portableLib/gridFactory","graphLineAndPointInteraction/runtime/wrappers/setOfPoints","graphLineAndPointInteraction/runtime/wrappers/points","graphLineAndPointInteraction/runtime/wrappers/lines","graphLineAndPointInteraction/runtime/wrappers/segments","graphLineAndPointInteraction/runtime/wrappers/solutionSet"],function($,qtiCustomInteractionContext,event,_,scaleRaphael,Raphael,gridFactory,setPointsWrapper,pointsWrapper,linesWrapper,segmentsWrapper,solutionSetWrapper){
...
response.record.push(formatResponseElement(element.id,selection))}):response.record.push(formatResponseElement(element.id,element.points))}),response},resetResponse:function(){},destroy:function(){var $container=$(this.dom);$container.off().empty()},setSerializedState:function(state){this.setResponse(state)},getSerializedState:function(){return this.getResponse()}};qtiCustomInteractionContext.register(graphLineAndPointInteraction)}),define(["graphLineAndPointInteraction/runtime/graphLineAndPointInteraction"],function(IMSPCI){return IMSPCI});
