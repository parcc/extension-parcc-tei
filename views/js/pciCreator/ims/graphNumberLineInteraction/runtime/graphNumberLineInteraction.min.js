...
return".css"==name.substr(name.length-4,4)&&(name=name.substr(0,name.length-4)),normalize(name)},cssAPI.load=function(cssId,req,load,config){(useImportLoad?importLoad:linkLoad)(req.toUrl(cssId+".css"),load)},cssAPI}),define("css!graphNumberLineInteraction/runtime/css/graphNumberLineInteraction",[],function(){}),define("graphNumberLineInteraction/runtime/graphNumberLineInteraction",["taoQtiItem/portableLib/jquery_2_1_1","qtiCustomInteractionContext","taoQtiItem/portableLib/lodash","taoQtiItem/portableLib/OAT/util/event","taoQtiItem/portableLib/OAT/scale.raphael","parccTei/portableLib/pointFactory","parccTei/portableLib/axisFactory","tpl!graphNumberLineInteraction/runtime/tpl/markup","graphNumberLineInteraction/runtime/libs/intervalFactory","text!graphNumberLineInteraction/runtime/img/arrow-close.svg","text!graphNumberLineInteraction/runtime/img/arrow-open.svg","text!graphNumberLineInteraction/runtime/img/close-arrow.svg","text!graphNumberLineInteraction/runtime/img/close-close.svg","text!graphNumberLineInteraction/runtime/img/close-open.svg","text!graphNumberLineInteraction/runtime/img/open-arrow.svg","text!graphNumberLineInteraction/runtime/img/open-close.svg","text!graphNumberLineInteraction/runtime/img/open-open.svg","css!graphNumberLineInteraction/runtime/css/graphNumberLineInteraction"],function($,qtiCustomInteractionContext,_,event,scaleRaphael,pointFactory,axisFactory,IntervalFactory,markupTpl,arrowCloseSvg,arrowOpenSvg,closeArrowSvg,closeCloseSvg,closeOpenSvg,openArrowSvg,openCloseSvg,openOpenSvg){
