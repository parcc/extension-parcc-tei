...
define([
    ...
    'histogramInteraction/creator/widget/Widget',
    'tpl!histogramInteraction/creator/tpl/markup'
], function(_, ciRegistry, Widget, markupTpl){
    'use strict';

    var _typeIdentifier = 'histogramInteraction';

    var histogramInteractionCreator = {
        /**
    ...
    return histogramInteractionCreator;
});
