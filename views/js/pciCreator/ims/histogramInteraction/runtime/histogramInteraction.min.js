...
(useImportLoad?importLoad:linkLoad)(req.toUrl(cssId+".css"),load)},cssAPI}),define("css!parccTei/pciCreator/ims/histogramInteraction/runtime/css/histogramInteraction",[],function(){}),define("histogramInteraction/runtime/histogramInteraction",["taoQtiItem/portableLib/jquery_2_1_1","qtiCustomInteractionContext","css!parccTei/pciCreator/ims/histogramInteraction/runtime/css/histogramInteraction"],function($,qtiCustomInteractionContext){var _typeIdentifier="histogramInteraction",histogramInteraction={getInstance:function(dom,config,state){var response=config.boundTo;this.initialize(Object.getOwnPropertyNames(response).pop(),dom,config.properties,config.assetManager),
this.setSerializedState(state),"function"==typeof config.onready&&config.onready(this,this.getState())},getState:function(){return this.getSerializedState()},oncompleted:function(){this.destroy()},getResponse:function(){var value=0;return{base:{integer:value}}},destroy:function(){var $container=$(this.dom);$container.off().empty()},getTypeIdentifier:function(){return _typeIdentifier},initialize:function(id,dom,config){this.id=id,this.dom=dom,this.config=config||{};$(dom)},setResponse:function(response){},resetResponse:function(){},setSerializedState:function(state){},getSerializedState:function(){return{}}};qtiCustomInteractionContext.register(histogramInteraction);
}),function(c){var d=document,a="appendChild",i="styleSheet",s=d.createElement("style");s.type="text/css",d.getElementsByTagName("head")[0][a](s),s[i]?s[i].cssText=c:s[a](d.createTextNode(c))}("/*add some style, need to scope (using the typeIdentifier as class prefix) every style declaration to prevent collision */\n\n.histogramInteraction{\n    width:100%;\n    padding:30px 30px 50px;\n    background-color:#f5f3f2;\n    margin:20px 0;\n}\n\n.histogramInteraction ul.likert{\n    list-style-type: none;\n    margin-top: 10px;\n    padding: 0;\n}\n\n.histogramInteraction ul.likert li{\n    float: left;\n    text-align: left;\n    list-style-type: none;\n}\n\n.histogramInteraction ul.likert li input{margin: 0 3px;}\n\n.histogramInteraction .prompt {position:relative;}\n\n.histogramInteraction .likert-label {min-width:90px; color: #444;}\n.histogramInteraction .likert-label-min {text-align: right;}\n.histogramInteraction .likert-label-max {text-align: left;}"),
define(["histogramInteraction/runtime/histogramInteraction"],function(IMSPCI){return IMSPCI});
//# sourceMappingURL=histogramInteraction.min.js.map