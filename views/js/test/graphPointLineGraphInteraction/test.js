...
define([
    ...
    'json!parccTei/test/samples/graphPointLineGraphInteraction.json'
], function($, _, qtiItemRunner, ciRegistry, pciTestProvider, graphPointLineGraphInteractionData){
    'use strict';
    ...
    QUnit.asyncTest('Display and play', function(assert){
        ...
        qtiItemRunner('qti', graphPointLineGraphInteractionData)
            .on('render', function(){
                QUnit.start();
            })
