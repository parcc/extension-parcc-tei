...
define([
    ...
    'json!parccTei/test/samples/histogramInteraction.json'
], function($, _, qtiItemRunner, ciRegistry, pciTestProvider, histogramInteractionData){
    'use strict';
    ...
    pciTestProvider.addManifestPath(
        ...
        'parccTei/pciCreator/ims/histogramInteraction/imsPciCreator.json');
    ...
    QUnit.asyncTest('Display and play', function(assert){
        ...
        qtiItemRunner('qti', histogramInteractionData)
            .on('render', function(){
                QUnit.start();
            })
