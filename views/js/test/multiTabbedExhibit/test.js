...
define([
    ...
    'json!parccTei/test/samples/multiTabbedExhibit.json'
], function($, _, qtiItemRunner, ciRegistry, pciTestProvider, multiTabbedExhibitData){
    'use strict';
    ...
    pciTestProvider.addManifestPath(
        'multiTabbedExhibit',
        'parccTei/pciCreator/ims/multiTabbedExhibit/imsPciCreator.json');
    ...
    QUnit.asyncTest('Display and play', function(assert){
        ...
        qtiItemRunner('qti', multiTabbedExhibitData)
            .on('render', function(){
                QUnit.start();
            })
